...
package com.wan.exotics.providers;
...
public class LocalStorageProvider extends DocumentsProvider {
    ...
    public static final String AUTHORITY = "com.wan.exotics.documents";
    ...
    public String createDocument(final String parentDocumentId, final String mimeType,
        ...
        try {
            ...
            ExoticsLogger.e(LocalStorageProvider.class.getSimpleName(), "Error creating new file " + newFile);
        }
        return null;
    }
    ...
    public AssetFileDescriptor openDocumentThumbnail(final String documentId, final Point sizeHint,
        ...
        try {
            ...
            ExoticsLogger.e(LocalStorageProvider.class.getSimpleName(), "Error writing thumbnail" + e.getMessage());
            return null;
        } finally {
            if (out != null)
                try {
                    ...
                    ExoticsLogger.e(LocalStorageProvider.class.getSimpleName(), "Error closing thumbnail" + e.getMessage());
                }
        }
