...
public class RoundedDrawable extends Drawable {
    ...
    public static Bitmap drawableToBitmap(Drawable drawable) {
        try{
            ...
            try {
                ...
                e.printStackTrace();
                ExoticsLogger.w(TAG, "Failed to create bitmap from drawable!");
                bitmap = null;
            }
     ...
     * @return the {@link RoundedDrawable} for chaining.
     */
    public RoundedDrawable setCornerRadius(@RoundedImageCorner int corner, float radius) {
    ...
    public RoundedDrawable setCornerRadius(float topLeft, float topRight, float bottomRight,
        ...
        mCornersRounded[RoundedImageCorner.TOP_LEFT] = topLeft > 0;
        mCornersRounded[RoundedImageCorner.TOP_RIGHT] = topRight > 0;
        mCornersRounded[RoundedImageCorner.BOTTOM_RIGHT] = bottomRight > 0;
        mCornersRounded[RoundedImageCorner.BOTTOM_LEFT] = bottomLeft > 0;
        return this;
    }
